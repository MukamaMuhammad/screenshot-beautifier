...
export const metadata = {
  title: "Compress jpeg to 20kb - Shotune",
  description:
    "Compress JPEG Images to 20KB: Free Online Tool. Optimize your visuals effortlessly. Convert large JPEGs to a smaller size for easy sharing and faster loading.",
};

const copy = {
  Title: "Compress JPEG to 20KB",
  paragraph:
    "Reduce the file size of your JPEG images to 20KB with our efficient online tool.",
  heading: "Key Features",
  subheading1: "Efficient Compression",
  paragraph1:
    "Compress your JPEG images to 20KB without compromising on quality.",
  ...
  paragraph66:
    "Effortlessly reduce the file size of your JPEG images to 20KB for various purposes, including web optimization and email attachments.",
  Title2: "How It Works",
  ...
  paragraph7:
    "Choose the compression level or target file size (20KB) for your image.",
  subheading8: "Click Compress",
  paragraph8: "Click the compress button to initiate the compression process.",
  paragraph9:
    "Download the compressed JPEG image with a reduced file size of 20KB.",
  Title3: "Why Choose Our JPEG Compressor?",
  paragraph10:
    "Efficiency: Quickly compress JPEG images to 20KB without quality loss.",
  ...
  paragraph16:
    "Begin reducing the file size of your JPEG images to 20KB with our hassle-free tool.",
  paragraph17:
