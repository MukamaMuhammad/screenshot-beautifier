...
export const metadata = {
  title: "Compress PNG to 200kb - Shotune",
  description:
    "Effortlessly optimize your PNG images to a manageable 200KB with our free online tool, maintaining their original quality.",
};

const copy = {
  Title: "Compress PNG to 200KB",
  paragraph:
    "Effortlessly reduce the size of your PNG images to 200KB with our online compression tool.",
  heading: "Key Features",
  subheading1: "Efficient Compression",
  paragraph1:
    "Effectively compress your PNG images to 200KB while preserving image quality.",
  ...
  paragraph3: "Our intuitive interface makes PNG compression quick and simple.",
  ...
  paragraph7:
    "Adjust the compression level or target file size (200KB) for your image.",
  subheading8: "Initiate Compression",
  paragraph8: "Click the compress button to start the compression process.",
  paragraph9:
    "Download the compressed PNG image with a reduced file size of 200KB.",
  Title3: "Why Choose Our PNG Compressor?",
  paragraph10:
    "Efficiency: Quickly compress PNG images to 200KB without compromising quality.",
  ...
  paragraph16:
    "Begin compressing your PNG images to 200KB with our hassle-free tool.",
  paragraph17:
